...
const MyTutorsPage = () => {
    ...
    return (
        ...
        <div className="min-h-screen bg-gradient-to-br from-violet-50 via-white to-purple-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 py-10 sm:py-14 px-3 sm:px-4">
            ...
            <div className="max-w-7xl mx-auto">
                ...
                {loading && (
                    <div className="flex justify-center items-center py-16 sm:py-20">
                        <div className="w-12 h-12 sm:w-14 sm:h-14 border-4 border-violet-200 dark:border-gray-700 border-t-violet-600 rounded-full animate-spin"></div>
                    </div>
                )}

                {/* Empty State */}
                {!loading && tutors.length === 0 && (
                    <div className="text-center py-16 sm:py-20 bg-white dark:bg-gray-900 rounded-2xl sm:rounded-3xl border border-violet-100 dark:border-gray-800 px-4">
                        <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 dark:text-white mb-2 sm:mb-3">
                ...
                {!loading && tutors.length > 0 && (
                    <div className="hidden sm:block overflow-x-auto bg-white dark:bg-gray-900 rounded-2xl sm:rounded-3xl shadow-lg border border-violet-100 dark:border-gray-800">

                        <table className="min-w-full text-sm sm:text-base">

                            <thead className="bg-violet-100 dark:bg-gray-800">
                                <tr>
                                    <th className="px-4 sm:px-6 py-3 sm:py-4 text-left font-bold text-gray-700 dark:text-gray-200">
                                        Photo
                                    </th>
                            ...
                            <tbody>
                                {tutors.map((tutor, index) => (
                                    <tr
                                        key={tutor._id}
                                        className={`border-t border-violet-50 dark:border-gray-800 ${index % 2 === 0
                                                ? "bg-white dark:bg-gray-900"
                                                : "bg-violet-50/40 dark:bg-gray-850"
                                            }`}
                                    >
                                        ...
                                        <td className="px-4 sm:px-6 py-3 sm:py-4 font-semibold text-gray-800 dark:text-white">
                                            {tutor.tutorName}
                                        </td>

                                        <td className="px-4 sm:px-6 py-3 sm:py-4 text-gray-600 dark:text-gray-300">
                                            {tutor.subject}
                                        </td>
                                        ...
                                        <td className="px-4 sm:px-6 py-3 sm:py-4 font-bold text-violet-700 dark:text-violet-400">
                                            {tutor.hourlyFee}
                                        </td>
